...
interface BudgetRemindersListProps {
  reminders: BudgetReminder[]
  onMarkRead: (reminderId: string) => void
  onDelete: (reminderId: string) => void
}

export function BudgetRemindersList({ reminders, onMarkRead, onDelete }: BudgetRemindersListProps) {
