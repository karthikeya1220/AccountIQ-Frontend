...
import { Trash2, Download, FileText, Edit2 } from "lucide-react"
import { Modal } from "@/components/common/modal"
import { PettyExpenseEditForm } from "./petty-expense-edit-form"
...
interface PettyExpensesListProps {
  ...
  onEdit?: (expense: PettyExpense) => void
  onExpenseUpdated?: (updatedExpense: PettyExpense) => void
}

export function PettyExpensesList({ expenses, onStatusChange, onDelete, onEdit, onExpenseUpdated }: PettyExpensesListProps) {
  ...
  const handleEditClick = (expense: PettyExpense) => {
    setEditingExpenseId(expense.id)
    onEdit?.(expense)
  }

  const handleSaveExpense = (updatedExpense: PettyExpense) => {
